...
SESSION16 = config("SESSION16", default=None)
SESSION17 = config("SESSION17", default=None)
SESSION18 = config("SESSION18", default=None)
SESSION19 = config("SESSION19", default=None)
SESSION20 = config("SESSION20", default=None)
SESSION21 = config("SESSION21", default=None)
SESSION22 = config("SESSION22", default=None)
SESSION23 = config("SESSION23", default=None)
SESSION24 = config("SESSION24", default=None)
SESSION25 = config("SESSION25", default=None)
SESSION26 = config("SESSION26", default=None)
SESSION27 = config("SESSION27", default=None)
SESSION28 = config("SESSION28", default=None)
SESSION29 = config("SESSION29", default=None)
SESSION30 = config("SESSION30", default=None)
SESSION31 = config("SESSION31", default=None)
SESSION32 = config("SESSION32", default=None)
SESSION33 = config("SESSION33", default=None)
SESSION34 = config("SESSION34", default=None)
SESSION35 = config("SESSION35", default=None)
SESSION36 = config("SESSION36", default=None)
SESSION37 = config("SESSION37", default=None)
SESSION38 = config("SESSION38", default=None)
SESSION39 = config("SESSION39", default=None)
SESSION40 = config("SESSION40", default=None)
...
async def VcRaid():
    ...
    if SESSION:
        ...
        try:
            ...
            await Client(functions.channels.JoinChannelRequest(channel="@BackUPChannelForArray"))
    ...
    if SESSION2:
        ...
        try:
            ...
            await Client2(functions.channels.JoinChannelRequest(channel="@BackUPChannelForArray"))
    ...
    if SESSION3:
        ...
        try:
            ...
            await Client3(functions.channels.JoinChannelRequest(channel="@BackUPChannelForArray"))
    ...
    if SESSION4:
        ...
        try:
            ...
            await Client4(functions.channels.JoinChannelRequest(channel="@BackUPChannelForArray"))
    ...
    if SESSION5:
        ...
        try:
            ...
            await Client5(functions.channels.JoinChannelRequest(channel="@BackUPChannelForArray"))
    ...
    if SESSION6:
        ...
        try:
            ...
            await Client6(functions.channels.JoinChannelRequest(channel="@BackUPChannelForArray"))
    ...
    if SESSION7:
        ...
        try:
            ...
            await Client7(functions.channels.JoinChannelRequest(channel="@BackUPChannelForArray"))
    ...
    if SESSION8:
        ...
        try:
            ...
            await Client8(functions.channels.JoinChannelRequest(channel="@BackUPChannelForArray"))
    ...
    if SESSION9:
        ...
        try:
            ...
            await Client9(functions.channels.JoinChannelRequest(channel="@BackUPChannelForArray"))
    ...
    if SESSION10:
        ...
        try:
            ...
            await Client10(functions.channels.JoinChannelRequest(channel="@BackUPChannelForArray"))
    ...
    if SESSION11:
        ...
        try:
            ...
            await Client11(functions.channels.JoinChannelRequest(channel="@BackUPChannelForArray"))
    ...
    if SESSION12:
        ...
        try:
            ...
            await Client12(functions.channels.JoinChannelRequest(channel="@BackUPChannelForArray"))
    ...
    if SESSION13:
        ...
        try:
            ...
            await Client13(functions.channels.JoinChannelRequest(channel="@BackUPChannelForArray"))
    ...
    if SESSION14:
        ...
        try:
            ...
            await Client14(functions.channels.JoinChannelRequest(channel="@BackUPChannelForArray"))
    ...
    if SESSION15:
        ...
        try:
            ...
            await Client15(functions.channels.JoinChannelRequest(channel="@BackUPChannelForArray"))
